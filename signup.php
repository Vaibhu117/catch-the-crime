...
<div class="container-fluid">
	<form action="" id="signup-frm">
		...
		<div class="form-group">
			...
			<input type="tel" pattern="[0-9]{4}[0-9]{3}[0-9]{3}" name="contact" required="" class="form-control" value="<?php echo isset($contact) ? $contact : '' ?>">
		</div>
		<div class="form-group">
			<label for="" class="control-label">Aadhar-Card</label>
			<!-- <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"> -->
			<input type="tel"  cols="30" rows="3" pattern="[0-9]{4}[0-9]{4}[0-9]{4}" name="address" required="" class="form-control" value="<?php echo isset($address) ? $address : '' ?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="password" name="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[#@$!%*?&])[A-Za-z\d#@$!%*?&]{8,}$" class="form-control" <?php echo isset($email) ? '' : "required" ?>>
			<?php if(isset($id)): ?>
