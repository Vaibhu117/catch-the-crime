...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<!-- <img src='../". $row['proof']." 'height='150px' width='280px''> -->
		<?php 
			$qry1 = $conn->query("SELECT * FROM complaints where id = {$_GET['id']} ");

			$result1 = mysqli_fetch_assoc($qry1);
		
			echo "<td> <img src='../". $result1['proof']." 'height='350px' width='660px''> </td>"; ?>
		...
		<form id="manage-complaints">
			...
			<!-- <form action="" method="post" enctype="multipart/form-data">
					  <input  name="Create" type="submit" value="Delete">
...
if(isset($_POST['Create']))
{
  ...
  $query = "DELETE FROM complaints WHERE complaints.id = {$_GET['id']}";
